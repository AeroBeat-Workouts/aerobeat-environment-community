...
func test_readme_documents_delete_first_restore_flow() -> void:
	...
	assert_true(text.contains("AeroVideoPlayerManager"), "README should document the stable tool-facing playback facade")
	assert_true(text.contains("AeroGodotVideoBackend"), "README should document the injected real Godot backend")
